      ...
      <div className="container-fluid">
        <ul className="navbar-nav">
          ...
          <div onClick={toggleExerciseOptions}>
            ...
            {exerciseOptionsVisible && (
              <div className="exercise-options">
                <NavLink to="/trainer_home/addT" className="nav-link" style={{ color: 'white' }}> Add Trainer</NavLink>
                <NavLink to="/trainer_home/assignT" className="nav-link" style={{ color: 'white' }}>Assign Workout</NavLink>
              </div>
            )}
            { <Routes>
